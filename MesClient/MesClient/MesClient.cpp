...
// MesClient.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMesClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMesClientApp

CMesClientApp::CMesClientApp()
{
...
// Единственный объект CMesClientApp

CMesClientApp theApp;


// Инициализация CMesClientApp

BOOL CMesClientApp::InitInstance()
{
